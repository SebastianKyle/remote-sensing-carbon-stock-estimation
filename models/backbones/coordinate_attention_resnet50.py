...
class CORResNet(nn.Module): 
    def __init__(self, pretrained=True, backbone_name='resnet50'):
        ...
        self.ca_fim2 = CA_FIM(256)
        self.ca_fim3 = CA_FIM(512)
        self.ca_fim4 = CA_FIM(1024)
        self.ca_fim5 = CA_FIM(2048)
        
        self.fusion2 = GC_FFM(256)
        self.fusion3 = GC_FFM(512)
        self.fusion4 = GC_FFM(1024)
        self.fusion5 = GC_FFM(2048)
    ...
    def forward(self, rgb_image, chm_image):
        ...
        rgb_features, chm_features = self.ca_fim2(rgb_features, chm_features)
        ...
        rgb_features, chm_features = self.ca_fim3(rgb_features, chm_features)
        ...
        rgb_features, chm_features = self.ca_fim4(rgb_features, chm_features)
        ...
        rgb_features, chm_features = self.ca_fim5(rgb_features, chm_features)
