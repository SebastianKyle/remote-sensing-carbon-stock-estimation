...
from models.attention.area_attention import AAttnFusion

class AAttnResNet(nn.Module): 
    def __init__(self, pretrained=True, backbone_name='resnet50'):
        super(AAttnResNet, self).__init__()
        ...
        self.fusion2 = AAttnFusion(256, area=8)
        self.fusion3 = AAttnFusion(512, area=4)
        self.fusion4 = AAttnFusion(1024, area=2)
        self.fusion5 = AAttnFusion(2048, area=1)
