...
class LKAResNet(nn.Module): 
    def __init__(self, pretrained=True, backbone_name='resnet50'):
        ...
        self.fusion2 = LKAFusion1(256)
        self.fusion3 = LKAFusion1(512)
        self.fusion4 = LKAFusion1(1024)
        self.fusion5 = LKAFusion1(2048)
