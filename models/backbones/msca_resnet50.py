...
from models.attention.msca import MSCAFusion, MSCAFusion1
from torchvision.ops.feature_pyramid_network import FeaturePyramidNetwork, LastLevelMaxPool

class MSCAResNet(nn.Module): 
    def __init__(self, pretrained=True, backbone_name='resnet50'):
        super(MSCAResNet, self).__init__()
        ...
        self.fusion2 = MSCAFusion1(256)
        self.fusion3 = MSCAFusion1(512)
        self.fusion4 = MSCAFusion1(1024)
        self.fusion5 = MSCAFusion1(2048)
